          ...
          <tbody>
            @foreach($visademande as $item)
                <tr>
                    ...
                    <td><a href="/marketing/seg-card-detail/{{$item->id}}">{{$demandeur['name_acteur']}}</a></td>
                    <td><a href="/marketing/seg-card-detail/{{$item->id}}">{{$demandeur['role_acteur']}}</a></td>
                    ...
                    @endif
                    <td>
                        <a class="link-btn mx-2 text-danger text-center" >
                            <i class="bi bi-trash-fill"></i>
                        </a>
                        <a class="link-btn mx-2 text-success">
